...
- [![](logo/star.svg)VSCode Essentials](https://marketplace.visualstudio.com/items?itemName=jabacchetta.vscode-essentials&ssr=false#overview)
- [![](logo/star.svg)Settings Sync](https://marketplace.visualstudio.com/items?itemName=Shan.code-settings-sync)
